...
for i in range(motion_lines):
    motion[str(i)] = {}
    # intialise motion line
    motion[str(i)]['glow1'], = ax.plot([], [], linewidth=5, color='#4d4dfe', alpha=.2)
    motion[str(i)]['glow2'], = ax.plot([], [], linewidth=4, color='#4d4dfe', alpha=.2)
    motion[str(i)]['glow3'], = ax.plot([], [], linewidth=3, color='#4d4dfe', alpha=.2)
    motion[str(i)]['glow4'], = ax.plot([], [], linewidth=2.5, color='#4d4dfe', alpha=.2)
...
anim.save('synthwave_run.gif', fps=60, writer='imagemagick')
